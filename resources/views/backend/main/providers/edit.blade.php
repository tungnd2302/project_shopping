          ...
          <form action="#" method="post" id="create_form">
            @csrf
                <div class="col-md-12" >
                  ...
                  <input type="text" name="txtTenSanPham" class="custom-form-control" style="margin-top: 10px" placeholder="Nhập tên nhà cung cấp" value="Công ty trách nhiệm hữu hạn abc">
                </div>

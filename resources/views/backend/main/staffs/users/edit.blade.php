                     ...
                     <form action="#" method="post" id="create_form">
                        @csrf
                            <div class="col-md-6">
                              ...
                              <input type="text" name="txtTenSanPham" class="custom-form-control" style="margin-top: 10px" value="tungnd0318" readonly="true">
                            </div>
                     ...
                     <form action="#" method="post" id="create_form">
                        @csrf
                            <div class="col-md-6">
                              ...
                              <input type="text" name="txtTenSanPham" class="custom-form-control" style="margin-top: 10px" placeholder="Nhập tên sản phẩm" value="Nguyễn Đức Tùng">
                            </div>
                            <div class="col-md-6">
                              <div>
                                <span style="font-size: 20px">Số điện thoại</span>
                              </div>
                              <input type="text" name="txtTenSanPham" class="custom-form-control" style="margin-top: 10px" placeholder="Nhập số điện thoại" value="0966 6374 98">
                            </div>

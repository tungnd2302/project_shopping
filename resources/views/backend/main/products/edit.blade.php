          ...
          <form action="#" method="post" id="create_form">
            @csrf
                <div class="col-md-6">
                  ...
                  <input type="text" name="txtTenSanPham" class="custom-form-control" style="margin-top: 10px" placeholder="Nhập tên sản phẩm" value="Sản phẩm cao cấp">
                </div>
                <div class="col-md-6">
                  <div>
                ...
                <div class="col-md-6" style="margin-top: 20px">
                  ...
                  <input type="text" class="custom-form-control" style="margin-top: 10px" placeholder="Nhập giá bán ra" value="400.000">
                </div>
                <div class="col-md-6" style="margin-top: 20px">
                  <div>
                    <span style="font-size: 20px">Số lượng nhập</span>
                  </div>
                  <input type="text" class="custom-form-control" style="margin-top: 10px" placeholder="Nhập số lượng nhập vào" value="40" readonly="true">
                </div>
                <div class="col-md-12" style="margin-top: 20px">
                  <div>
